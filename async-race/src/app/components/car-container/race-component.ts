...
export function carIcon(carColor: string) {
    ...
    element.node.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="80px" version="1.1" x="0px" y="0px" viewBox="0 0 90 62.5" enable-background="new 0 0 90 50" xml:space="preserve">
